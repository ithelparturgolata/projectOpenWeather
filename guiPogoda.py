...
class Weather():
    ...
    def report(self):
        ...
        if self.data["cod"] == "404":
            messagebox.showwarning("Błąd", "Wpisz nazwę miasta bez znaków diakretycznych")
        else:
    ...
    def __init__(self):
        ...
        self.date = Label(self.root, text=datetime.now().date(), bg="#666699", fg="#FFFFFF", font=self.font)
        self.date.place(x=400, y=5)

        self.heading = Label(self.root, text="Aktualna pogoda", bg="#666699", fg="#FFFFFF", font=self.font)
        self.heading.place(x=180, y=5)

        self.location = Label(self.root, text="Miasto", bg="#666699", fg="#FFFFFF", font=self.font)
        self.location.place(x=10, y=5)

        self.name = Label(self.root, text="Wpisz miasto", fg="#000000", font=self.font)
        self.name.place(x=140, y=45)

        self.loc = Text(self.root, width=25, height=1)
        self.loc.place(x=140, y=70)

        self.button = Button(self.root, text="Szukaj", bg="#666699", fg="white", relief=RAISED, command=self.report, font=self.font)
        self.button.place(x=350, y=65)

        self.button1 = Button(self.root, text="Wyczyść", bg="#666699", fg="white", relief=RAISED, command=self.clear,font=self.font)
        self.button1.place(x=420, y=65)

        self.report = Label(self.root, text="Raport pogodowy", bg="#666699", fg="#FFFFFF", font=self.font, padx=10)
        self.report.place(x=180, y=120)

        self.report2 = Label(self.root, text="Warunki: ", bg="#666699", fg="#FFFFFF", font=self.font, padx=10)
        self.report2.place(x=50, y=160)

        self.report3 = Label(self.root, text="Temperatura: ", bg="#666699", fg="#FFFFFF", font=self.font, padx=10)
        self.report3.place(x=50, y=200)

        self.report4 = Label(self.root, text="Wilgotność: ", bg="#666699", fg="#FFFFFF", font=self.font, padx=10)
        self.report4.place(x=50, y=240)

        self.report5 = Label(self.root, text="Ciśnienie: ", bg="#666699", fg="#FFFFFF", font=self.font, padx=10)
        ...
        self.humidity2 = Label(self.root, text="%", fg="#00274c", font=self.font)
        ...
        self.pressure2 = Label(self.root, text="hPa", fg="#00274c", font=self.font)
